...
return [
    ...
    */
    'columns'                       => [
        'alpha'   => [
            'rows'  => ['subject_name','description', 'email', 'name', 'slug'],
            'class' => 'far fa-sort-alpha',
        ],
        'amount'  => [
            'rows'  => ['amount', 'price'],
            'class' => 'far fa-sort-amount',
        ],
        'numeric' => [
            'rows'  => ['created_at', 'updated_at', 'level', 'id', 'phone_number'],
            'class' => 'far fa-sort-numeric',
        ],
    ],
     ...
     */
    'default_icon_set'              => 'far fa-sort',

    /*
    icon that shows when generating sortable link while column is not sorted
     */
    'sortable_icon'                 => 'far fa-sort',
