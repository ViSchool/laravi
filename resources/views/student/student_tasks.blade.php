               ...
               @foreach ($tasksByUnits as $unit_id => $tasks)
                  ...
                  <div class="card mb-3">
                     <div class="card-header">
                        <div class="d-flex flex-row row align-items-center" id="headingOne">
                           <div class="m-0 p-0 col-6">
                              <button class="btn btn-link text-left" type="button" data-toggle="collapse" data-target="#collapse_{{$unit->id}}_{{$teacher_id}}" aria-expanded="false" aria-controls="collapse_{{$unit->id}}_{{$teacher_id}}">
                           ...
                           <div class="col-3">
                              ...
                              @if ($task_example->taskStatus_id > 2)
                                 <a class="btn-sm btn-warning" href="/unit/{{$unit->id}}"> Zur Lerneinheit </a>
                              @endif
                     ...
                     @if (session('unit_open') == $unit->id) 
                         <div id="collapse_{{$unit->id}}_{{$teacher_id}}" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion_units">
                     @else
                        <div id="collapse_{{$unit->id}}_{{$teacher_id}}" class="collapse" aria-labelledby="headingOne" data-parent="#accordion_units">
                     @endif
                        <div class="card-body">
