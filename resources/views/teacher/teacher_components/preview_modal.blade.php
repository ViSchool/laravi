						...
						<div class="card-header text-white" role="tab" id="start_block" style="background-color:#03c4eb">
							...
							@isset($unit->unit_img)
								<div class="row mb-3">
									...
									<div class="col-6">
										<img class="img-fluid img-thumbnail" src="/images/units/{{$unit->unit_img}}">
									</div>
									<div class="col-3">
									</div>
								</div>
            	...
            	@if ($differentiationExists == 1)
						<div class="card my-1">
							<div class="card-body">
								<div class="row">
									<div class="col-8">
										<p>Diese Lerneinheit enthält unterschiedliche Aufgaben für verschiedene Lernniveaus. Wähle Dir hier Dein Lernniveau aus, damit Du nur Deine Aufgaben siehst. Wenn Du nicht sicher bist, welches Lernniveau Du auswählen sollst, frage bitte Deinen Lehrer</p>
									</div>
									<div class="col-2">
										<div class="dropdown">
