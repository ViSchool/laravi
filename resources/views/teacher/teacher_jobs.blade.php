                                                        ...
                                                        <td class="text-center">
                                                            @if($job->jobStatus_id < 3)
                                                                <form action="/lehrer/auftrag/zuteilen" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <button title="Jetzt die Aufträge für die Klasse {{$studentgroup->studentgroup_name}} zuweisen und mit dem Lernen beginnen lassen" class="btn-sm" type="submit"><i class="fas fa-user-check"></i> Auftrag jetzt zuteilen</button>
                                                                </form>
                                                            @else 
                                                                <small>{{$job->jobStatus->jobStatus_name}}</small>
                                                            @endif
