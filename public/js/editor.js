		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
						   ...
						   'insert_link': { "modal": true,
											...
											"modalHeader": "Hyperlink einfügen",
											...
											"onSave":function(){
												...
												if(targetURL ==''){
													methods.showMessage.apply(editorObj,["errMsg","Bitte eine URL eintragen"]);
													return false;
												}												
												if(!targetURL.match(urlPattern)){
													methods.showMessage.apply(editorObj,["errMsg","Bitte eine gültige URL eintragen"]);
													return false;
												}													
												if(range=='' && targetText==''){ 
						...
						'insert_table'	: { "modal": true,
						   ...
						   'outdent'	: { "text": "Outdent", 
							...
							'rm_format'	: { "text": "Formatierung entfernen", 
											"icon":"fa fa-eraser", 
								            	...
								            	class:"modal-dialog"
							            			...
							            			class:"modal-content"
									            		...
									            		class:"modal-footer"
								                			...
								                			type:"button",
								                			class:"btn btn-success",
								               				}).html('Fertig').mousedown(function(e){
								                			e.preventDefault();
