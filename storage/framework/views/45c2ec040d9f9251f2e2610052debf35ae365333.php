...
<?php echo e(csrf_field()); ?>
	...
	<div class="form-group">
		...
		<div class="input-group mb-3">
			...
			<input type="text" class="form-control" id="portal_title" name="portal_title">
		</div>
		
		<div class="form-group">
			<label for="portal_description">Beschreibung des Portals:</label>
			<textarea class="form-control" name="portal_description" id="portal_description"></textarea>
		</div>
		...
		<div class="input-group mb-3">
			...
			<input type="url" class="form-control" id="portal_url" name="portal_url" placeholder="URL des Portals hierhin kopieren"></input>
		</div>
