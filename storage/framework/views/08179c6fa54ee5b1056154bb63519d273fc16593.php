<nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
	...
	<li class="nav-item">
		<a class="nav-link" href="#">Unterrichtseinheiten</a>
	</li>
	<li class="nav-item">
	...
	<ul class="nav nav-pills flex-column">
		...
		<li class="nav-item">
			 <a class="nav-link" href="<?php echo e(route('admin.logout')); ?>"><i class="far fa-sign-out-alt"></i> Logout</a>
  		</li>
  		<li class="nav-item">
			 <a class="nav-link" href="<?php echo e(route('vischool')); ?>"><i class="far fa-home"></i> ViSchool</a>
  		</li>
	</ul>
</nav>
