	...
	<div id="carouselUnits" class="carousel slide" data-ride="carousel" style="width: 80%; max-width:600px; margin: 0 auto">
		<div class="carousel-inner">
			<div class="carousel-item active">
				...
				<img class="p-5" src="/images/units/<?php echo e($unit01->unit_img); ?>" style="max-width:100%; height:auto; max-height:300px; z-index:1;" alt="First slide">
				<div class="carousel-caption">
					<div class="d-none d-sm-block">
						<p><a class="btn btn-primary" href="/lerneinheit/<?php echo e($unit01->id); ?>" role="button"><?php echo e($unit01->unit_title); ?></a></p>
					</div>
					<div class="d-block d-sm-none">
						<p><a class="btn-sm btn-primary" href="/lerneinheit/<?php echo e($unit01->id); ?>" role="button"><?php echo e($unit01->unit_title); ?></a></p>
					</div>
				</div>
			</div>
			...
			<div class="carousel-item bg-white">
				<?php if(isset($unit->unit_img)): ?>
					...
					<img class="p-5 img-fluid d-block" src="/images/units/<?php echo e($unit->unit_img); ?>" style="max-width:100%; height:auto; max-height:300px; z-index:1;" alt="First slide">
				<?php endif; ?>
				...
				<div class="carousel-caption">
					<div class="d-none d-sm-block">
						<p><a class="btn btn-primary" href="/lerneinheit/<?php echo e($unit->id); ?>" role="button"><?php echo e($unit->unit_title); ?></a></p>
					</div>
					<div class="d-block d-sm-none">
						<p><a class="btn-sm btn-primary" href="/lerneinheit/<?php echo e($unit01->id); ?> role="button"><?php echo e($unit->unit_title); ?></a></p>
					</div>
				</div>
			</div>
