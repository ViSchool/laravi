			...
			<div class="card-header" role="tab">
				...
				<div class="row my-3">
					<div class="col-7">
						...
						<input type="hidden" name="unit_id" value="<?php echo e($id); ?>">
					</div>
					<div class="col">
...
</form><?php /**PATH /Users/katmac/Sites/vischool/laravi/resources/views/oldstuff/new_block.blade.php ENDPATH**/ ?>