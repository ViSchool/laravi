...
<div id="fh5co-pricing" class="fh5co-bg-section">
		<div class="container">
			<div class="row animate-box">
				<div class="col-sm-12 col-md-offset-3 text-center fh5co-heading">
					<h2>Plan &amp; Pricing</h2>
			...
			<div class="row">
				<div class="pricing pricing--rabten">
					<div class="col-md-4 col-sm-8 animate-box">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/katmac/Sites/vischool/laravi/resources/views/oldstuff/contents/index.blade.php ENDPATH**/ ?>